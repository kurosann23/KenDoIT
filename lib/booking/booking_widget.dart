...
class _BookingWidgetState extends State<BookingWidget> {
  ...
  void initState() {
    ...
    _model.backgroundFocusNode!.addListener(() => setState(() {}));
    _model.facultyTextController1 ??= TextEditingController();
    _model.facultyFocusNode1 ??= FocusNode();
    _model.facultyFocusNode1!.addListener(() => setState(() {}));
    _model.facultyTextController2 ??= TextEditingController();
    _model.facultyFocusNode2 ??= FocusNode();
    _model.facultyFocusNode2!.addListener(() => setState(() {}));
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'School/Universities/Company*',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                            fontFamily: 'Outfit',
                                      ...
                                      filled: true,
                                      fillColor: (_model.backgroundFocusNode
                                                  ?.hasFocus ??
                                              false)
                                          ? const Color(0x4D9489F5)
                                          : Colors.white,
                                    ...
                                    validator: _model
                                        ...
                                        .asValidator(context),
                                    inputFormatters: [_model.backgroundMask],
                                  ),
                                  Text(
                                    'Gender',
                                    style: FlutterFlowTheme.of(context)
                                  ...
                                  TextFormField(
                                    controller: _model.facultyTextController1,
                                    focusNode: _model.facultyFocusNode1,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor:
                                          (_model.facultyFocusNode1?.hasFocus ??
                                                  false)
                                              ? const Color(0x4D9489F5)
                                              : Colors.white,
                                      contentPadding:
                                    ...
                                    cursorColor: const Color(0xFF6F61EF),
                                    validator: _model
                                        .facultyTextController1Validator
                                        .asValidator(context),
                                  ),
                                  TextFormField(
                                    controller: _model.facultyTextController2,
                                    focusNode: _model.facultyFocusNode2,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor:
                                          (_model.facultyFocusNode2?.hasFocus ??
                                                  false)
                                              ? const Color(0x4D9489F5)
                                              : Colors.white,
                                      contentPadding:
                                    ...
                                    cursorColor: const Color(0xFF6F61EF),
                                    validator: _model
                                        .facultyTextController2Validator
                                        .asValidator(context),
                                  ),
                                  TextFormField(
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            options: FFButtonOptions(
                              ...
                              borderRadius: BorderRadius.circular(8.0),
                              hoverColor: const Color(0xFF694BB0),
                            ),
                          ),
                        ),
                      ],
